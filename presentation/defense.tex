...
\begin{frame}{Combine and Integrate}
	...
	\alert<3>{end $if$} \\
	\alert<4>{(Optional) Add circular velocity to the current velocity.}	\\ 
	\alert<5>{$pos_i^{k+1}$ +=  $dt $* $vel_i^{k+1}$}					\\
...
\begin{frame}{RTPS-FLOCK system}
	\begin{figure}[htbp]
	\begin{center}
	\includegraphics[scale=0.3]{../figures/RTPSvsRTPS.pdf}
...
\begin{frame}{Bees approaching their hive simulation}
	...
	\end{array}$
	\end{center}
	\caption{Demonstration of the \textit{goal} rule}
	\end{figure}
\end{frame}
\begin{frame}{Bees approaching their hive simulation}
	\begin{figure}[htbp]
...
\begin{frame}{Crowding simulation}
	...
	\begin{center}$
	\begin{array}{ccc}
	\includegraphics[scale=0.15]{../figures/demo_crowds1.pdf} &
	\includegraphics[scale=0.15]{../figures/demo_crowds2.pdf}
	\end{array}$
	\end{center}
	\caption{A hose emitting boids into the FLOCK system}
	\end{figure}
\end{frame}
...
\begin{frame}{Crowding simulation}
	\begin{figure}[htbp]
	\begin{center}
	\includegraphics[scale=0.20]{../figures/demo_crowds3.pdf}
	\caption{Boids are following the rules and they already spread out into the world.}
	\end{center}
	\end{figure}
\end{frame}
