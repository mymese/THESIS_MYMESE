...
\begin{frame}{Final Velocity}
	\pause The final velocity of the boids is calculated as a linear combination of the steering behaviors.
...
\begin{frame}{The Blender Game Engine}
	\begin{itemize}
		\pause \item Game Engines are used to simulate partial reality.
...
\begin{frame}{The Blender Game Engine}
	\begin{itemize}
		...
		\pause \item Boids particle systems are added to the Blender Game Engine as a modifier interface.
	\end{itemize}
\end{frame}
...
\begin{frame}{Emitting particles to the system}
	...
	\texttt{num} 	& num particles are emitted and num is reset to 0	\\\hline 
