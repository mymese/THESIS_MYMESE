...
\begin{frame}{Flocking}
	...
	\end{center}
	\caption{Flocking behavior: School of fish}
	\label{default}
	\end{figure}
...
\begin{frame}{Craig Reynolds}
	\begin{itemize}
		...
		\pause \item Most recognized paper: \textit{Flocks, Herds, and Schools: A Distributed Behavioral Model} revolutionized the field of flocking.
	\end{itemize}
\end{frame}
...
\begin{frame}{Flocking Using the GPU}
	\begin{itemize}
		\pause \item Flocking algorithms are amenable to massive parallelization since each boid is subject to identical rules.
...
\begin{frame}{Aim}
	\pause
	\begin{center}
	\textit{To develop a flocking implementation that can be used in the Blender Game Engine.}
	\end{center}
\end{frame}
...
% flocking algorithm
%--------------------------------------------
\section{Rules and Algorithms}

\begin{frame}
	\begin{center}
		\textbf{Rules and Algorithms}
	\end{center}
\end{frame}
...
\begin{frame}{Final Velocity}
	The final velocity of the boids is calculated as the current velocity plus a linear combination of the steering behaviors.
...
% implementation
%--------------------------------------------
\section{RTPS Implementation}

\begin{frame}
	\begin{center}
		\textbf{RTPS Implementation}
	\end{center}
\end{frame}
...
% RTPS diagram
\begin{frame}{RTPS library diagram}
	\pause
	\begin{figure}[htbp]
	\begin{center}
...
% FLOCK diagram
\begin{frame}{FLOCK system diagram}
	\pause
	\begin{figure}[htbp]
	\begin{center}
...
\begin{frame}{Nearest Neighbor Search}
	\begin{itemize}
		\pause \item \textbf{BitonicSort} sorts the hash array by their hash values
...
\begin{frame}{The Blender Game Engine}
	\begin{itemize}
		...
		\pause \item The Blender Game Engine lets you create simple games without the need for explicit programming.
...
\begin{frame}{The Blender Game Engine}
	\begin{itemize}
		...
		\pause \item We would like to add this missing feature.
...
\begin{frame}{Emitting boids to the system}
	...
	\texttt{hose}	& active the hose	\\\hline
...
\begin{frame}{Conclusions}
	\begin{itemize}
		...
		\item A Boids system can be run inside the Blender Game Engine using the RTPS modifier.
		\item The RTPS modifier runs up to 20x faster than the Boids system of Blender.
	\end{itemize}
\end{frame}
...
\begin{frame}{Future work}
	\begin{itemize}
		...
		\item Use Swarm Intelligence to select an optimized set of parameters for the Boids system.
		\item Support hybrid systems.
