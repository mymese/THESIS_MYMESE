...
\textcolor{red}{** OLMO: change the word part in this sentence ** A game engine is a software or part of a software that simulates part of reality\cite{bookGameKit2}}. Game engines let you interact with 3D world in real-time. Also, you can control objects that interact with other objects in the world. A game engine consist of several functions:
\begin{enumerate}
